%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Cost function for MLE in PN case
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function J = costFun_PN(decVars, r, R, tmod, texp_ind, Cexp, NT_data, pars_nom, Var_data, Weights, ODEoptions)
...
J  = sum(sum(Weights.*((NT_data - NT_mod).^2)./Var_data));
