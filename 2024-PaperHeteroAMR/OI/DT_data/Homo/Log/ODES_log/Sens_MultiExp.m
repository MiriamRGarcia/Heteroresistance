%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Calculate average and their sensitivities
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [yT, sens_yT] = Sens_MultiExp(tmod, rr, Cexp, par, y0, ODEoptions)
...
AA_kxi = AA_kxi/log(10);

% Calculate growth rate:
mug    = (mugS*mugR./(mugR + (mugS - mugR)*rr.^alphg))/log(10);
...
for iexp = 1:Nexp
    ...
    [~, St_sens] = ode15s(@(t,s) Odes_Sens(t, s, AA, AA_mugS, AA_mugR, AA_alphg,...
                   AA_mukmaxS, AA_r50k, AA_alphk, AA_EC50k, AA_Hk, AA_xiSR, AA_kxi), tmod, s0, ODEoptions);
