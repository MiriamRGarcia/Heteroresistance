%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PanelSimRes: Main file to plot simulation results of stochastic TKA 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% IMPORTANT NOTE: This script is not adapted for m_r = 2. Use only
%                 if m_r > 2;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clear variables
...
% Indexes of experiments to plot:
Exps   = [1 2 3 4 5 9];
...
[~, N_Tmod] = Sim_aveBD(r, R, tsim, Cexp, pars, ODEoptions);
...
Cexp_plot = linspace(Cexp(1), Cexp(end-1), 50);
m_e   = numel(Cexp);
Pext = zeros(m_t, m_e);
...
for iC = 1:m_e
    ...
    [~, zout] = ode15s(@(t,s) Odes_Pext(t, s, b, d, AA), tsim, z0, ODEoptions);
    zz        = zout(1:m_t, m_r + 2);
